...
showmessage('        yedekleme baþarýyla yapýldý !'+#13+' sakýn " D:\gunluk yedek " klasörünü silme !!'+#13+'þuandan itibaren günlük programý tekrar kurulana kadar çalýþmýyacak !!')
else
...
showmessage('UpDate baþarýlý !'+#13+' kurulumdan sonra yazdýðýn günlük silindi !'+#13+'þuan son yedeklediðin bilgiler geri geldi..')
else
showmessage('hata yedeklenemedi d:\gunluk yedek\alidatabase.mdb ye ulaþýlamýyor ! ') ;
end;
